...
METRIC_UPDATE_INTERVAL_SECONDS = 30 # How often to send new metric values
INITIAL_SOC = 45.0
FINAL_SOC = 80.0
INITIAL_KWH = 12.3
...
def run_simulation(args):
    ...
    print("\n--- Starting Charge Simulation ---")
    print(f"Vehicle: {args.user}, Owner: {args.owner}")
    print(f"Duration: {SIMULATION_DURATION_MINUTES} minutes, Update Interval: {METRIC_UPDATE_INTERVAL_SECONDS} seconds")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PyOVMS Charge Session Simulator")
